                        ...
                        <div class="row">
                            ...
                            <article class="col-sm-3 col-xs-6">
                                ...
                                <figure>
                                    ...
                                    <figcaption>
                                        <div class="hovereffect">
                                            <img class="img-responsive" src="<?php echo url("") ?>/images/albums/album_interior/square/bgnocu-4.jpg" alt="">
                                            <div class="overlay">
                                                <a class="info lightbox" href="<?php echo url("") ?>/images/albums/album_interior/bgnocu-4.jpg"></a>
                                            </div>
                                        </div>
                                    </figcaption>
                                </figure>
                            ...
                            <article class="col-sm-3 col-xs-6">
                                ...
                                <figure>
                                    ...
                                    <figcaption>
                                        <div class="hovereffect">
                                            <img class="img-responsive" src="<?php echo url("") ?>/images/albums/album_interior/square/bgnocu-5.jpg" alt="">
                                            <div class="overlay">
                                                <a class="info lightbox" href="<?php echo url("") ?>/images/albums/album_interior/bgnocu-5.jpg"></a>
                                            </div>
                                        </div>
                                    </figcaption>
                                </figure>
