                        ...
                        <ul class="clearfix">
                            ...
                            <li class="col-sm-3">
                                ...
                                <figure>
                                    ...
                                    <a href="{{ route("album", ["album" => "12012017"]) }}" class="info">
                            ...
                            <li class="col-sm-3">
                                ...
                                <figure>
                                    ...
                                    <a href="{{ route("album", ["album" => "13012017"]) }}" class="info">
                            ...
                            <li class="col-sm-3">
                                ...
                                <figure>
                                    ...
                                    <a href="{{ route("album", ["album" => "14012017"]) }}" class="info">
                                ...
                                <figure>
                                    ...
                                    <figcaption>
                                        ...
                                        <div class="hovereffect">
                                            ...
                                            <img class="img-responsive" src="<?php echo url("") ?>/images/albums/album_12012017/cover.jpg" alt="">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="eventHover">
                                            ...
                                            <div  class="evSubtitle"> 
                                                ...
                                                <a href="{{ route("album", ["album" => "12012017"]) }}" class="info"> view album </a>
